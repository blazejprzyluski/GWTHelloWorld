...
_.addCustomer_0_g$ = function t_e_g$(){
  ...
  if (!mKd_g$(lastName_0_g$, '^[A-Za-z]{1,25}$')) {
    NNc_g$("'" + lastName_0_g$ + "' is not a valid first name");
...
function z5c_g$(){
  ...
  gVc_g$.call(this);
  this.$init_753_g$();
  this.tableRow_0_g$ = zJc_g$();
  WIc_g$(this.getBody_1_g$(), this.tableRow_0_g$);
  Rgb_g$(this.getTable_0_g$(), 'cellSpacing', '0');
  Rgb_g$(this.getTable_0_g$(), 'cellPadding', '0');
}

xuc_g$(1182, 1103, {864:1, 887:1, 1060:1, 1103:1, 1106:1, 1157:1, 1166:1, 1175:1, 1177:1, 1179:1, 1180:1, 1182:1, 1190:1, 1191:1, 1192:1, 1193:1, 1196:1, 1241:1, 1317:1, 1331:1, 1423:1, 1:1}, z5c_g$);
_.$init_753_g$ = function y5c_g$(){
  x5c_g$();
  this.horzAlign_0_g$ = ($4c_g$() , ALIGN_DEFAULT_0_g$);
  this.vertAlign_0_g$ = (o5c_g$() , ALIGN_TOP_0_g$);
}
;
_.add_3_g$ = function A5c_g$(child_0_g$){
  Auc_g$(1241).add_3_g$.call(this, child_0_g$);
}
;
_.add_4_g$ = function B5c_g$(w_0_g$){
  var td_0_g$;
  td_0_g$ = this.createAlignedTd_0_g$();
  WIc_g$(this.tableRow_0_g$, td_0_g$);
  this.add_5_g$(w_0_g$, td_0_g$);
}
;
_.createAlignedTd_0_g$ = function C5c_g$(){
  x5c_g$();
  var td_0_g$;
  td_0_g$ = vJc_g$();
...
;
_.getHorizontalAlignment_0_g$ = function D5c_g$(){
  return this.horzAlign_0_g$;
}
;
_.getVerticalAlignment_0_g$ = function E5c_g$(){
  return this.vertAlign_0_g$;
}
;
_.insert_2_g$ = function F5c_g$(w_0_g$, beforeIndex_0_g$){
  this.insert_3_g$(XRc_g$(w_0_g$), beforeIndex_0_g$);
}
;
_.insert_3_g$ = function G5c_g$(w_0_g$, beforeIndex_0_g$){
  var td_0_g$;
  this.checkIndexBoundsForInsertion_0_g$(beforeIndex_0_g$);
  td_0_g$ = this.createAlignedTd_0_g$();
  AKc_g$(this.tableRow_0_g$, td_0_g$, beforeIndex_0_g$);
  this.insert_0_g$(w_0_g$, td_0_g$, beforeIndex_0_g$, false);
}
;
_.onEnsureDebugId_0_g$ = function H5c_g$(baseID_0_g$){
...
;
_.remove_5_g$ = function I5c_g$(w_0_g$){
  var removed_0_g$, td_0_g$;
  td_0_g$ = xKc_g$(w_0_g$.getElement_0_g$());
  removed_0_g$ = Auc_g$(1106).remove_5_g$.call(this, w_0_g$);
  if (removed_0_g$) {
    Reb_g$(this.tableRow_0_g$, td_0_g$);
  }
  return removed_0_g$;
}
;
_.setHorizontalAlignment_0_g$ = function J5c_g$(align_0_g$){
  this.horzAlign_0_g$ = align_0_g$;
}
;
_.setVerticalAlignment_1_g$ = function K5c_g$(align_0_g$){
  this.vertAlign_0_g$ = align_0_g$;
}
;
var Lcom_google_gwt_user_client_ui_HorizontalPanel_2_classLit_0_g$ = HAd_g$('com.google.gwt.user.client.ui', 'HorizontalPanel', 1182, Lcom_google_gwt_user_client_ui_CellPanel_2_classLit_0_g$);
function I7c_g$(){
  I7c_g$ = Object;
}
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/com.blazejprzyluski.App/D39A6E61973E360A636AE6CA67F4B5D2_sourcemap.json 
