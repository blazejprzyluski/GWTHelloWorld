...
function bZe_g$(l_0_0_g$, e_1_0_g$){
  t_g$();
  l_0_0_g$.setText_0_g$('Hello world');
}
...
_.onModuleLoad_0_g$ = function x_g$(){
  var b_0_g$, l_0_g$;
  b_0_g$ = new $Uc_g$('Hello World');
  l_0_g$ = new e1c_g$('Blank');
  b_0_g$.addClickHandler_0_g$(new cZe_g$(l_0_g$));
  bhd_g$().add_4_g$(b_0_g$);
  bhd_g$().add_4_g$(l_0_g$);
}
;
...
function cZe_g$(l_0_0_g$){
  y_g$();
  this.l_0_1_g$ = l_0_0_g$;
}

xuc_g$(7, 1, {7:1, 746:1, 880:1, 1:1}, cZe_g$);
_.$init_2_g$ = function z_g$(){
  y_g$();
}
;
_.onClick_0_g$ = function B_g$(arg0_0_g$){
  bZe_g$(this.l_0_1_g$, arg0_0_g$);
}
;
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/com.blazejprzyluski.App/AD3BC4664E190D18628F4D139800B270_sourcemap.json 
