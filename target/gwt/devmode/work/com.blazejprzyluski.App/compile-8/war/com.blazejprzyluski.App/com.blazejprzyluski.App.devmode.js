...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.com.blazejprzyluski.App=");
    idx += (13 + "com.blazejprzyluski.App".length);  // 
  }
  if (idx >= 0) {
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/com.blazejprzyluski.App/_sourcemap.json 
